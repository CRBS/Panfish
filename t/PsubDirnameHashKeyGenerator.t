...
#
{
   ...
   my $keyGen = Panfish::PsubDirnameHashKeyGenerator->new($logger);
...
#
# Test where FileUtil is not set
#
{
   my $logger = Mock::Logger->new(1);
   ...
   my $keyGen = Panfish::PsubDirnameHashKeyGenerator->new($logger,$mockGen);
...
#
{
   ...
   my $keyGen = Panfish::PsubDirnameHashKeyGenerator->new($logger,$mockGen,$fUtil);
...
#
{
   ...
   $fUtil->addGetDirnameResult("/home/foo/blat/123.4.psub","/home/foo/blat");

   ok($keyGen->getKey($job) eq "/home/foo/blat");
